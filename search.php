...
<?php include_once 'navbar.php'; ?>
    ...
    <div class="container">
        <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-3 row-cols-xxl-4">
            <?php include 'inc/dashboard.inc.php'; foreach($search_fetch_tb_lapak as $result): ?>
                <div class="">
                    <div class="col">
                        <div class="card mx-md-3 mx-lg-auto mb-3" style="width: 18.5rem;">
                            <img style="max-width: 300px; max-height: 150px;" src="img/uploadsInsert/<?=$result['img_url'] ?>" class="card-img-top img-thumbnail" alt="...">
                                <div class="card-body shadow-lg bg-body rounded p-4">
                                    ...
                                    <p class="card-text" style="text-align: center;">Rp<?=htmlspecialchars($result['harga']);?></p>
                                    <div class="d-grid gap-1">
                                        <a class="btn btn-primary" href="CRUD/detail.php?id=<?=$result['id'];?>" > Detail</a>
                                    </div>
                                </div>
                        </div>
                    </div>
